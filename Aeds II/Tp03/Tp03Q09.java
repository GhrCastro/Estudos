...
public class Tp03Q09{
   ...
   public static class PilhaDupla {
    ...
    public static void main(String[] args) {  //Método main para testes-->
        ...
        ArrayList<Pokemon> pokemons = new ArrayList<>(); // Array dos pokémons a partir dos IDs
        ...
        entrada = sc.nextLine();
        int numOperacoes = Integer.parseInt(entrada);
        ...
        for (int i = 0; i < numOperacoes; i++) {
            ...
            if (parts.length > 1) {
                pokemon.read(parts[1]);
            }
            
            pilha.operar(operacao, pokemon, value);
        }
